<template>
  <header style="background-color: black">
    <nav class="navbar navbar-expand-custom navbar-mainbg">
      <a class="navbar-brand navbar-logo" href="#">Land Title BlockChain</a>
      <button
      ...
      >
        <ul class="navbar-nav ml-auto">
          ...
          >
            <router-link class="nav-link" to="/feature_view"
              ><i class="fa fa-folder-plus"></i>Map</router-link
            >
          </li>
          <li
            class="nav-item"
          ...
          <li class="nav-item" v-if="isAuth" @click.prevent="onLogout()">
            <router-link
              class="nav-link"
              to="/accesswallet"
...
export default {
  ...
  methods: {
    ...
    onLogout() {
      this.logout();
      // this.$router.replace("/accesswallet");
    },
  },
};
</script>
